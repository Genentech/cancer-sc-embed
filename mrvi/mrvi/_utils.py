...
class ConditionalBatchNorm1d(nn.Module):
    def __init__(self, num_features, num_vars):
        super().__init__()
        self.num_features = num_features
        self.bn = nn.BatchNorm1d(num_features, affine=False)

        #implement Conditional Batch Normalization based on continuous values
        self.embed = nn.Linear(num_vars, num_features * 2)
